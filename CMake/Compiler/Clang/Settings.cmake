...
if(WITH_WARNINGS)
  target_compile_options(projectWaaagh-warning-interface
    INTERFACE
      -W
      -Wall
      -Wextra
...
if(WITH_COREDEBUG)
  target_compile_options(projectWaaagh-compile-option-interface
    INTERFACE
      -g3)
...
if(ASAN)
  ...
  target_link_options(projectWaaagh-compile-option-interface
    INTERFACE
      -fno-omit-frame-pointer
      -fsanitize=address
      -fsanitize-recover=address
...
if(BUILD_SHARED_LIBS)
  ...
  target_compile_options(projectWaaagh-hidden-symbols-interface
    INTERFACE
      -fvisibility=hidden)
