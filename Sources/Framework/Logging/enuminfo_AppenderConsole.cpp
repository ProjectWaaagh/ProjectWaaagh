...
namespace ProjectWaaagh::Impl::EnumUtilsImpl {
    template<>
    PRW_API_EXPORT EnumText EnumUtils<ColorTypes>::ToString(ColorTypes value) {
        switch (value) {
    ...
    template<>
    PRW_API_EXPORT size_t EnumUtils<ColorTypes>::Count() { return 15; }
    
    template<>
    PRW_API_EXPORT ColorTypes EnumUtils<ColorTypes>::FromIndex(size_t index) {
        switch (index) {
            case 0: return BLACK;
            case 1: return RED;
            case 2: return GREEN;
    ...
    template<>
    PRW_API_EXPORT size_t EnumUtils<ColorTypes>::ToIndex(ColorTypes index) {
        switch (index) {
            case BLACK: return 0;
            case RED: return 1;
            case GREEN: return 2;
