#ifndef PROJECTWAAAGH_SMARTENUM_HPP
#define PROJECTWAAAGH_SMARTENUM_HPP
...
public:
    template <typename Enum>
    static size_t Count() { return ProjectWaaagh::Impl::EnumUtilsImpl::EnumUtils<Enum>::Count(); }
    template <typename Enum>
    static EnumText ToString(Enum value) { return ProjectWaaagh::Impl::EnumUtilsImpl::EnumUtils<Enum>::ToString(value); }
    template <typename Enum>
    static Enum FromIndex(size_t index) { return ProjectWaaagh::Impl::EnumUtilsImpl::EnumUtils<Enum>::FromIndex(index); }
    template <typename Enum>
    static uint32 ToIndex(Enum value) { return ProjectWaaagh::Impl::EnumUtilsImpl::EnumUtils<Enum>::ToIndex(value);}
...
#endif // !PROJECTWAAAGH_SMARTENUM_HPP
