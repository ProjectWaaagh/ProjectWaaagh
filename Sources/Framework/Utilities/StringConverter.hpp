#ifndef PROJECTWAAAGH_STRINGCONVERTER_HPP
#define PROJECTWAAAGH_STRINGCONVERTER_HPP
...
namespace ProjectWaaagh::Impl::StringConvertImpl {

	template<typename T, typename = void> 
	struct For {
		static_assert(ProjectWaaagh::dependant_false_v<T>, "Unsupported type used for ToString or StringTo");
	};
...
#ifdef PROJECTWAAAGH_NEED_CHARCONV_WORKAROUND

#endif // PROJECTWAAAGH_NEED_CHARCONV_WORKAROUND
...
#endif // PROJECTWAAAGH_COMPILER == PROJECTWAAAGH_COMPILER_MICROSOFT
}
...
namespace ProjectWaaagh {
	...
	Optional<Result> StringTo(std::string_view str, Params&&... params) {
		return ProjectWaaagh::Impl::StringConvertImpl::For<Result>::FromString(str, std::forward<Params>(params)...);
	}

	template<typename Type, typename... Params>
	std::string ToString(Type&& val, Params&&... params) {
		return ProjectWaaagh::Impl::StringConvertImpl::For<std::decay_t<Type>>::ToString(std::forward<Type>(val), std::forward<Params>(params)...);
	}
}

#endif // !PROJECTWAAAGH_STRINGCONVERTER_HPP
